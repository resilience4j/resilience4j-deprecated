...
We want to make contributing to *Resilience4j* as easy and transparent as possible.
...
If you discover unexpected behaviour or find a bug in the source code, you can help us by submitting an issue via https://github.com/resilience4j/resilience4j/issues[GitHub Issues].
...
It allows us to quickly confirm a bug (or point out a coding problem) as well as confirm that we are fixing the right problem.
...
TIP: No ideas?
See issues tagged as https://github.com/resilience4j/resilience4j/issues?q=is%3Aissue+is%3Aopen+label%3A%22help+wanted%22[*help wanted*].

CAUTION: Even if you would like to start with a Pull Request first, please submit an issue with a proposal for your work first, to be sure that we can use it.
...
(https://blog.jetbrains.com/idea/2019/06/managing-code-style-on-a-directory-level-with-editorconfig/[Idea]) and https://gist.github.com/wojteklu/73c6914cc446146b8b533c0988cf8d29[Clean Code] rules.
